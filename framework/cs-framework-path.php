 ...
 *
 */
if ( ! function_exists( 'cs_get_manager_option' ) ) {
  function cs_get_manager_option( $option_name = '', $default = '' ) {

    $options = apply_filters( 'cs_get_manager_option', get_option( CS_MANAGER ), $option_name, $default );
 ...
 *
 */
if ( ! function_exists( 'cs_set_manager_option' ) ) {
  function cs_set_manager_option( $option_name = '', $new_value = '' ) {

    $options = apply_filters( 'cs_set_manager_option', get_option( CS_MANAGER ), $option_name, $new_value );

    if( ! empty( $option_name ) ) {
      $options[$option_name] = $new_value;
      update_option( CS_MANAGER, $options );
    }
 ...
 *
 */
if ( ! function_exists( 'cs_get_all_manager_option' ) ) {
  function cs_get_all_manager_option() {
    return get_option( CS_MANAGER );
  }
}
/*---------------- end manager(自定义)---------------------*/
/*---------------- start plug(自定义)---------------------*/
