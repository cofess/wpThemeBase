...
<body>
<div class="container-fluid bg-black parallax">
  ...
  <div class="fullwidth abs-bottom">
    <div class="example-container" id="example-line-container" style="width:<?php echo cs_get_manager_option('maintenance_progress');?>%" data-toggle="tooltip" data-placement="top" title="<?php echo cs_get_manager_option('maintenance_progress');?>%"></div>
  </div>
</div>
<div class="footer">
